...
export const commentsApi = {
  ...
  resolve: (commentId: string) => api.post<void>(`/comments/${commentId}/resolve`, undefined),

  unresolve: (commentId: string) => api.post<void>(`/comments/${commentId}/unresolve`, undefined)
};
